...
- (void)viewDidLoad
{
    ...
    [self handleSplitViewBarButtonItem:self.masterViewControllerBarButtonItem];
}
...
{
   if (masterViewControllerBarButtonItem != _masterViewControllerBarButtonItem) {
       [self handleSplitViewBarButtonItem:masterViewControllerBarButtonItem];
   }
//------------------
//   _masterViewControllerBarButtonItem = masterViewControllerBarButtonItem;
//    [self.navigationItem setLeftBarButtonItem:masterViewControllerBarButtonItem];
 //----------------------
}
...
- (void)handleSplitViewBarButtonItem:(UIBarButtonItem *)masterViewControllerBarButtonItem
{
    NSMutableArray *toolbarItems = [self.toolBar.items mutableCopy];
    if (_masterViewControllerBarButtonItem) [toolbarItems removeObject:_masterViewControllerBarButtonItem];
    if (masterViewControllerBarButtonItem) [toolbarItems insertObject:masterViewControllerBarButtonItem atIndex:0];
